# automatizacion-de-reportes-de-ventas
Pipeline en Python para ingesta de datos, cálculo de KPIs, generación de reportes en Excel y PDF, y envío automático por email.
